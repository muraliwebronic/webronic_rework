  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid gap-10 lg:grid-cols-6 md:grid-cols-3 grid-cols-1 sm:grid-cols-2">
          <div className="space-y-6 lg:col-span-2 md:col-span-3">
            <div className="flex justify-start">
              {/* Ensure you use a logo version that works on white background */}
              <Image
              ...
              {[
                ...
                <li key={item.label}>
                  {item.isExternal ? (
                    <Link
                      href={item.id}
                      className="text-xs md:text-sm text-slate-500 hover:text-[#2776ea] transition-all flex items-center group cursor-pointer"
                    >
                      <item.icon
                        size={13}
                    ...
                    <button
                      ...
                      className="text-xs md:text-sm text-slate-500 hover:text-[#2776ea] transition-all flex items-center group bg-transparent border-none p-0 cursor-pointer text-left"
                    >
                      <item.icon
                        size={13}
                        className="mr-2 text-slate-400 group-hover:text-[#2776ea] transition-colors shrink-0"
        ...
        <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 text-center md:text-left">
