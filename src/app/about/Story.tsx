    ...
    <section className="py-24 lg:py-32 bg-white relative overflow-hidden font-sora">
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className="relative">
          {/* Central Timeline Track with Scroll Animation */}
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 -translate-x-1/2 flex flex-col items-center">
                    <motion.div 
                      ...
                      className="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center shadow-sm z-30 group-hover:border-[#2776ea] transition-colors duration-500"
                    >
