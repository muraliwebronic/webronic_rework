                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute left-4 md:left-1/2 -translate-x-1/2 flex flex-col items-center">
                      ...
                      {/* Year Badge (Floating) */}
                      <div
                        className={`hidden md:block absolute top-1/2 -translate-y-1/2 whitespace-nowrap px-4 py-1 rounded-full bg-slate-50 border border-slate-100 text-slate-500 font-bold text-caption tracking-wider transition-all duration-500 group-hover:scale-105 group-hover:text-[#2776ea] ${
        ...
        <div className="container mx-auto px-6 max-w-7xl">
              ...
              <ul className="space-y-6">
                {certifications.cloud.map((p, i) => (
                  <li key={i} className="flex gap-4">
                    ...
                    <div>
                      <p className="font-bold text-slate-900 text-submenu">{p.name}</p>
                      <p className="text-caption text-slate-500 mt-1">{p.desc}</p>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <div className="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <h3 className="font-bold text-slate-900 uppercase tracking-widest text-caption">
              ...
              <div className="space-y-4">
                {culture.points.map((pt, i) => (
                  ...
                  >
                    ...
                    <span className="font-bold text-slate-700 text-submenu">
                      {pt}
                    </span>
                  </div>
                ))}
