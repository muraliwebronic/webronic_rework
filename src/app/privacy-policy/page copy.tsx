...
export default function PrivacyPolicy() {
      ...
      <section className="relative overflow-hidden bg-slate-50 py-24 border-b border-slate-100">
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-white border border-slate-200 px-4 py-1.5 mb-8 shadow-sm">
            <ShieldCheck size={14} className="text-[#2776ea]" />
          ...
          <h1 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tighter leading-tight">
            Privacy <span className="text-[#2776ea]">Policy</span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-8 text-sm font-bold text-slate-400">
            <div className="flex items-center gap-2">
              <Clock size={18} className="text-[#2776ea]" /> Last Updated: Dec 18, 2025
            </div>
            <div className="flex items-center gap-2">
              <Globe size={18} className="text-[#76ea27]" /> Webronic Industries Private Limited
            </div>
          </div>
        </div>
      </section>
          ...
          <aside className="hidden lg:block sticky top-32 h-[calc(100vh-140px)] overflow-y-auto pr-4 custom-scrollbar">
            <div className="space-y-1">
              ...
              {sections.map((item) => (
                ...
                >
                  <item.icon size={16} className="group-hover:scale-110 transition-transform text-slate-400 group-hover:text-[#2776ea]" />
                  {item.title}
                </a>
              ))}
            </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 bg-white border border-slate-100 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-sm relative overflow-hidden">
    ...
    <div className="bg-slate-50 rounded-xl md:rounded-3xl p-5 md:p-6 border border-slate-100">
      <p className="text-[10px] font-black text-[#2776ea] uppercase tracking-widest mb-4">Dedicated Support</p>
            ...
            <div id="collection" className="scroll-mt-32">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-6 rounded-3xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-[#2776ea]/30 transition-all group">
                    <div className="flex items-center gap-3 mb-3">
                       <item.icon size={18} className="text-[#76ea27]" />
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {[
                      ...
                      <tr key={i} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-[10px] text-[#2776ea] font-black uppercase">{row.l}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div id="sharing" className="scroll-mt-32">
              ...
              <div className="space-y-6">
                <div className="bg-slate-900 text-white p-8 rounded-[2.5rem]">
                   <h4 className="text-xs font-black uppercase tracking-widest text-[#76ea27] mb-6">6.1 When We Share Your Data</h4>
                   <ul className="grid sm:grid-cols-2 gap-4 list-none p-0">
                      {["Service Providers", "Professional Advisors", "Government Authorities", "Strategic Partners"].map(li => (
                        <li key={li} className="flex items-center gap-3 text-sm font-bold opacity-80">
                           <CheckCircle2 size={16} className="text-[#76ea27]" /> {li}
                        </li>
                      ))}
                   </ul>
                </div>
                <div className="p-8 border border-slate-100 rounded-[2.5rem]">
                   <h4 className="text-xs font-black uppercase tracking-widest text-[#2776ea] mb-4">6.2 International Data Transfers</h4>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-5 rounded-2xl bg-slate-900 text-white shadow-lg">
                    <ShieldCheck size={20} className="text-[#76ea27] shrink-0" />
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                 {[
                   ...
                   <div key={i} className="p-6 rounded-3xl bg-slate-50 border border-slate-100 text-center">
                      <item.icon size={20} className="mx-auto mb-3 text-[#76ea27]" />
            ...
            <div id="rights" className="scroll-mt-32">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={i} className="p-5 rounded-2xl border border-slate-100 bg-white flex flex-col justify-between h-32 hover:border-[#2776ea] transition-all">
                    <p className="text-[10px] font-black text-[#76ea27] uppercase">0{i+1}</p>
              ...
              <div className="mt-8 flex flex-col md:flex-row gap-4 items-center justify-between p-8 rounded-4xl bg-slate-50 border border-slate-100">
                <p className="text-sm font-medium text-slate-500">To exercise these rights, email us at <span className="text-[#2776ea] font-bold">privacy@webronic.com</span>. We aim to respond within 30 days.</p>
              </div>
            </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    {["Clear Processing Instructions", "Sub-processor safeguards", "Audit & Deletion rights", "Security Breach Protocols"].map((item) => (
                      <div key={item} className="flex items-center gap-3">
                        <CheckCircle2 size={16} className="text-[#76ea27]" />
            ...
            <div id="compliance" className="scroll-mt-32">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={item.title} className="p-6 rounded-2xl border-2 border-slate-50 bg-white hover:border-[#2776ea] transition-all">
                    <p className="text-[10px] font-black text-[#76ea27] uppercase mb-1">{item.sub}</p>
