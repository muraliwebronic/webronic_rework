...
import { DIGITAL_TRANSFORMATION_HERO_DATA } from "@/data/Digital/DIGITAL_TRANSFORMATION_HERO_DATA";

export default function DigitalTransformationHero() {
  const { header, h1, h1Highlight, subHeadline, valueProps, ctas } = DIGITAL_TRANSFORMATION_HERO_DATA;
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex items-center gap-4 mb-6">
              <header.icon size={16} className="text-[#2776ea]" />
            ...
            {/* Headline */}
            <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl leading-tight mb-6">
          ...
          {/* --- RIGHT COLUMN: ANIMATED VISUAL (Transformation Theme) --- */}
          <div className="relative h-[400px] lg:h-[500px] w-full flex items-center justify-center">
            ...
            {/* Central Node: Globe (Digital/Global) */}
            ...
            {/* Orbiting Node 2: Users (Change Management) - Gray */}
            <div
            ...
            {/* Orbiting Node 3: TrendingUp (Business Outcomes) - Dark/Accent */}
            <div
            ...
            >
              <TrendingUp size={40} className="text-yellow-400 fill-yellow-400" />
            </div>
