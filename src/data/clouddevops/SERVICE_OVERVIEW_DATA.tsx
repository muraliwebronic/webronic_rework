export const SERVICE_OVERVIEW_DATA = {
  ...
  // The narrative text split into paragraphs
  content: [
  ...
  partnerships: {
    intro: "We hold advanced partnership status with all major cloud providers:",
    list: [
      "AWS Advanced Consulting Partner",
      "Microsoft Azure Gold Partner",
      "Google Cloud Platform Partner"
    ],
    outro: "This partnership status provides our clients with access to specialized support, early access to new services, and architectural guidance directly from cloud vendors"
  }
};