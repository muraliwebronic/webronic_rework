export const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "Investment varies based on project scope. Small proof-of-concept projects start around $25,000-50,000. Production-grade solutions typically range from $100,000-500,000. Enterprise-scale implementations can exceed $1M. We provide detailed estimates after initial discovery and scoping",
  },
  {
    question: "Can you start with a pilot project before full implementation?",
    answer: "Absolutely. We recommend starting with a focused pilot to prove value before scaling. Typical pilots last 8-12 weeks, demonstrate capabilities on a subset of data, and provide clear success metrics that inform the decision to scale",
  },
];