...
export const ABOUT_PAGE_DATA = {
  ...
  contact: {
    ...
    social: [
      { platform: "LinkedIn", link: "linkedin.com/company/webronic", icon: Linkedin },
      { platform: "Twitter", link: "@webronic", icon: Twitter },
      { platform: "Facebook", link: "facebook.com/webronic", icon: Facebook },
      { platform: "YouTube", link: "youtube.com/webronic", icon: Youtube },
      { platform: "Instagram", link: "@webronic_tech", icon: Instagram }
    ]
  }
};